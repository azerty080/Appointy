...
@section('content')
    ...
    <form method="POST" action="{{ route('register') }}" class="clientForm">
        @csrf
        <h2>Klant account</h2>
    ...
    <form method="POST" action="{{ route('register') }}" class="businessForm hide">
        @csrf
        <h2>Zaak account</h2>
            ...
            <div class="dayDiv" id="monday">
                ...
                <div class="hoursDiv">
                    <div>
                        ...
                        <input class="limitedInput hide" name="monday_open_afternoon" type="time" value="13:00" disabled>
                    </div>

                    <div>
                        <label>Sluitingsuur</label>

                        <input class="limitedInput hide" name="monday_close_morning" type="time" value="12:00" disabled>
            ...
            <div class="dayDiv" id="tuesday">
                ...
                <div class="hoursDiv">
                    <div>
                        ...
                        <input class="limitedInput hide" name="tuesday_open_afternoon" type="time" value="13:00" disabled>
                    </div>

                    <div>
                        <label>Sluitingsuur</label>

                        <input class="limitedInput hide" name="tuesday_close_morning" type="time" value="12:00" disabled>
            ...
            <div class="dayDiv" id="wednesday">
                ...
                <div class="hoursDiv">
                    <div>
                        ...
                        <input class="limitedInput hide" name="wednesday_open_afternoon" type="time" value="13:00" disabled>
                    </div>

                    <div>
                        <label>Sluitingsuur</label>

                        <input class="limitedInput hide" name="wednesday_close_morning" type="time" value="12:00" disabled>
            ...
            <div class="dayDiv" id="thursday">
                ...
                <div class="hoursDiv">
                    <div>
                        ...
                        <input class="limitedInput hide" name="thursday_open_afternoon" type="time" value="13:00" disabled>
                    </div>

                    <div>
                        <label>Sluitingsuur</label>

                        <input class="limitedInput hide" name="thursday_close_morning" type="time" value="12:00" disabled>
            ...
            <div class="dayDiv" id="friday">
                ...
                <div class="hoursDiv">
                    <div>
                        ...
                        <input class="limitedInput hide" name="friday_open_afternoon" type="time" value="13:00" disabled>
                    </div>

                    <div>
                        <label>Sluitingsuur</label>

                        <input class="limitedInput hide" name="friday_close_morning" type="time" value="12:00" disabled>
            ...
            <div class="dayDiv" id="saturday">
                ...
                <div class="hoursDiv">
                    <div>
                        ...
                        <input class="limitedInput hide" name="saturday_open_afternoon" type="time" value="13:00" disabled>
                    </div>
                    
                    <div>
                        <label>Sluitingsuur</label>
                    
                        <input class="limitedInput hide" name="saturday_close_morning" type="time" value="12:00" disabled>
            ...
            <div class="dayDiv" id="sunday">
                ...
                <div class="hoursDiv">
                    <div>
                        ...
                        <input class="limitedInput hide" name="sunday_open_afternoon" type="time" value="13:00" disabled>
                    </div>

                    <div>
                        <label>Sluitingsuur</label>

                        <input class="limitedInput hide" name="sunday_close_morning" type="time" value="12:00" disabled>
